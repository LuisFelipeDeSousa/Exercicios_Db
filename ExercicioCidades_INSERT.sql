...
SELECT estado 'Estado', cidade ' Cidade'
...
-- Selecione a cidade que o nome da cidade contenha mais que 15 caracteres, ordenando pelo quantidade decaracteres.

SELECT cidade, LEN(cidade) AS 'Quantidade'
FROM cidades 
WHERE LEN(cidade) > 15 ORDER BY 'Quantidade';
...
------- NOSSA QUERIDA E "SIMPATICA" BLUMENAU --------

SELECT cidade FROM cidades WHERE cidade = 'Blumenau';